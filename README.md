...
| 2 — Position persistence   | Capture/restore wired into the extension, popup v1   | ✅ Done |
...
**Milestone M2** (end of Epic 2): the position-persistence feature is dogfoodable daily. Acceptance is manual — see the [dogfooding guide](docs/dogfooding.md).
